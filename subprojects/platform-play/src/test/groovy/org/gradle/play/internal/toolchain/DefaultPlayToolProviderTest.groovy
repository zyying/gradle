...
class DefaultPlayToolProviderTest extends Specification {
    ...
    private DefaultPlayToolProvider createProvider() {
        return new DefaultPlayToolProvider(forkOptionsFactory, daemonWorkingDir, classPathRegistry, workerDaemonFactory, workerProcessBuilderFactory, playPlatform, twirlClasspath, routesClasspath, javascriptClasspath, fingerprinter)
    }
