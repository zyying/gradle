...
public class ConventionAwareHelper implements ConventionMapping, HasConvention {
     ...
     */
    public ConventionAwareHelper(IConventionAware source, Convention convention, ClassInspector classInspector) {
        this._source = source;
        this._convention = convention;
        this._propertyNames = classInspector.inspect(GeneratedSubclasses.unpackType(source)).getPropertyNames();
    }
