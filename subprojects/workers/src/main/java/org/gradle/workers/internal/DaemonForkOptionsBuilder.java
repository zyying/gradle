...
public class DaemonForkOptionsBuilder {
    ...
    private ClassLoaderStructure classLoaderStructure = IsolatedClassloaderWorker.getDefaultClassLoaderStructure(Collections.<File>emptyList());
    ...
    public DaemonForkOptionsBuilder classpath(Iterable<File> classpath) {
        this.classLoaderStructure = IsolatedClassloaderWorker.getDefaultClassLoaderStructure(classpath);
        return this;
    }
