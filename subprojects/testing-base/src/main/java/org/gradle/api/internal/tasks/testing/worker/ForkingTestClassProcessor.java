...
public class ForkingTestClassProcessor implements TestClassProcessor {
    ...
    List<URL> getTestWorkerImplementationClasspath() {
        return CollectionUtils.flattenCollections(URL.class,
            ...
            moduleRegistry.getModule("gradle-persistent-cache").getImplementationClasspath().getAsURLs(),
            moduleRegistry.getModule("gradle-jvm-services").getImplementationClasspath().getAsURLs(),
