...
class DownloadingScalaToolChainTest extends Specification {
    ...
    DownloadingScalaToolChain scalaToolChain = new DownloadingScalaToolChain(gradleUserHome, rootProjectDir, classPathRegistry, workerDaemonFactory, configurationContainer, dependencyHandler, forkOptionsFactory)
